...
//        result.get().forEach(a -> log.info(Arrays.toString(a)));
    ...
    public void testSearchPage(){
        ...
        pageRequestDTO.setKeyword("10");

        pageRequestDTO.setSort(Sort.by("bno").descending().and(Sort.by("title").ascending()));
        log.info(pageRequestDTO.getPageable());
        Page<Object[]> result = boardRepository.searchPage(pageRequestDTO);
